...
)  AUTO_INCREMENT = 340  COMMENT = '账户表' ;
...
CREATE TABLE tb_account_player  (
  ...
  del_flag bit(1) NULL DEFAULT b'0' COMMENT '删除标记',
  PRIMARY KEY (id) USING BTREE
)  AUTO_INCREMENT = 309  COMMENT = '账号角色' ;
...
CREATE TABLE tb_game_instance  (
  ...
  del_flag bit(1) NULL DEFAULT b'0' COMMENT '删除标记',
  PRIMARY KEY (id) USING BTREE
)  AUTO_INCREMENT = 2  COMMENT = '游戏副本表' ;
...
CREATE TABLE tb_instance_npc  (
  ...
  del_flag bit(1) NULL DEFAULT b'0' COMMENT '删除标记',
  PRIMARY KEY (id) USING BTREE
)  AUTO_INCREMENT = 7  COMMENT = '游戏副本NPC表' ;
...
CREATE TABLE tb_npc_drop  (
  ...
  del_flag bit(1) NULL DEFAULT b'0' COMMENT '删除标记',
  PRIMARY KEY (id) USING BTREE
)  AUTO_INCREMENT = 2  COMMENT = 'npc掉落物品表' ;
...
CREATE TABLE tb_player_level_exp  (
  ...
  del_flag bit(1) NULL DEFAULT b'0' COMMENT '删除标记',
  PRIMARY KEY (id) USING BTREE
)  AUTO_INCREMENT = 43  COMMENT = '角色等级数据表' ;
...
CREATE TABLE tb_player_weapon  (
  ...
  del_flag bit(1) NULL DEFAULT b'0' COMMENT '删除标记',
  PRIMARY KEY (id) USING BTREE
)  AUTO_INCREMENT = 388  COMMENT = '角色武器表' ;
